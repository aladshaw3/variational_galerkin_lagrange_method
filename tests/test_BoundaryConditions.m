...
r21 = bc2.eval_dLdc(u2,c_2,0,l2);
r22 = bc2.eval_dLdl(u2,c_2,0,l2);

assert( norm(r21-[2;0;0;0;0]) < 1e-4 )
assert( abs(r22 - 3) < 1e-4 )


%% Test 2 - Scalar Neumann BC 
...
assert( norm(r11-[0;1]) < 1e-4 )
assert( abs(r12 + 3) < 1e-4 )

r21 = bc2.eval_dLdc(u2,c_2,0,l2);
r22 = bc2.eval_dLdl(u2,c_2,0,l2);

assert( norm(r21-[0;2;0;0;0]) < 1e-4 )
assert( abs(r22 - 5) < 1e-4 )
